...
public class AttendanceReportsValidationTest extends TestUtilsMethod {
	...
	public void NavigationToAttendanceReporttab() {
		driver.get(
				"https://opensource-demo.orangehrmlive.com/web/index.php/time/displayAttendanceSummaryReportCriteria");
	}
	...
	public void testNavigationToAttendancReporttab() {
		NavigationToAttendanceReporttab();
	...
	public void testToShowUserAttendanceReport() throws InterruptedException {
		...
		jobTitle.click();
		WebElement jobTitleOption = wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//span[contains(text(), '" + "Account Assistant" + "')]")));
	...
	public void testToVerifyUserAttendanceInReports() throws InterruptedException {
		...
		WebElement userActualAttendance = wait.until(ExpectedConditions.presenceOfElementLocated(
				By.xpath("/html/body/div/div[1]/div[2]/div[2]/div[2]/div[3]/div/div[2]/div/div/div[6]")));
		String userActualTime = userActualAttendance.getText();
