...
@Slf4j
public class EmailConfigAutomate {
	...
	public static void main(String[] args) {
		...
		login(driver);
		navigateToEmailConfigPage(driver);
		configureEmailSettings(driver, "info@orangehrm.com", "Sendmail", true, "test.email@example.com");
	...
	private static void navigateToEmailConfigPage(WebDriver driver) {
		...
		log.info("Navigated to the Email Configuration page.");
	}

	private static void configureEmailSettings(WebDriver driver, String mailSentAs, String sendingMethod,
			boolean sendTestMail, String testEmailAddress) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
