...
@Slf4j
public class AddLicenseAutomateTest extends TestUtilsMethod {

	@Test
	private static void addLicense() throws InterruptedException {
		NavigationTabMethods.navigateToLicensePage();

		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));

		String licenseName = "CodeRED";
